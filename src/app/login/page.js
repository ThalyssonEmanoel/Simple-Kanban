...
export default function LoginPage() {
  ...
  async function handleLogin(e) {
    ...
    // Hard navigation so middleware sees the fresh session cookies on desktop
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl bg-white p-8 shadow-lg">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-gray-700 font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-200 transition-colors"
          >
